...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Wiki.subdomain'
        db.alter_column(u'app_wiki', 'subdomain', self.gf('django.db.models.fields.TextField')(default='foo', unique=True))
        # Adding unique constraint on 'Wiki', fields ['subdomain']
        db.create_unique(u'app_wiki', ['subdomain'])


    def backwards(self, orm):
        # Removing unique constraint on 'Wiki', fields ['subdomain']
        db.delete_unique(u'app_wiki', ['subdomain'])


        # Changing field 'Wiki.subdomain'
        db.alter_column(u'app_wiki', 'subdomain', self.gf('django.db.models.fields.TextField')(null=True))
