...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Story.last_editor'
        db.alter_column(u'app_story', 'last_editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['app.WikiaUser']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Story.last_editor'
        raise RuntimeError("Cannot reverse this migration. 'Story.last_editor' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Story.last_editor'
        db.alter_column(u'app_story', 'last_editor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.WikiaUser']))
