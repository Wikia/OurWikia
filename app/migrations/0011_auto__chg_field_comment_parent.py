...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_comment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['app.Comment']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Comment.parent'
        db.alter_column(u'app_comment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Comment']))

    models = {
        u'app.comment': {
            'Meta': {'object_name': 'Comment'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['app.Comment']"}),
            'story': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments'", 'to': u"orm['app.Story']"}),
        ...
        u'app.story': {
            ...
            'hotness': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'app.wikiauser': {
            'Meta': {'unique_together': "(('wikia_user_id', 'wiki'),)", 'object_name': 'WikiaUser'},
        ...
        u'app.wikihotness': {
            'Meta': {'object_name': 'WikiHotness'},
            'hotness': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'story': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'wiki_hotness'", 'unique': 'True', 'to': u"orm['app.Story']"}),
            'wiki': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'hotness'", 'unique': 'True', 'to': u"orm['app.Wiki']"})
        },
        u'auth.group': {
