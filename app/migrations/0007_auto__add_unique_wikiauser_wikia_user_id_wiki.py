...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WikiaUser', fields ['wikia_user_id', 'wiki']
        db.create_unique(u'app_wikiauser', ['wikia_user_id', 'wiki_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WikiaUser', fields ['wikia_user_id', 'wiki']
        db.delete_unique(u'app_wikiauser', ['wikia_user_id', 'wiki_id'])
