...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.story'
        db.add_column(u'app_comment', 'story',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='comments', to=orm['app.Story']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.story'
        db.delete_column(u'app_comment', 'story_id')
