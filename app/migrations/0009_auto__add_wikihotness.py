...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WikiHotness'
        db.create_table(u'app_wikihotness', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wiki', self.gf('django.db.models.fields.related.OneToOneField')(related_name='hotness', unique=True, to=orm['app.Wiki'])),
            ('story', self.gf('django.db.models.fields.related.OneToOneField')(related_name='wiki_hotness', unique=True, to=orm['app.Story'])),
            ('hotness', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'app', ['WikiHotness'])


    def backwards(self, orm):
        # Deleting model 'WikiHotness'
        db.delete_table(u'app_wikihotness')
